...
import { BiBox, BiCategory, BiHome, BiSolidCoupon, BiTask, BiUserCircle } from "react-icons/bi";
				...
				<NavLink
					...
					className={({ isActive }) =>
						`flex items-center gap-5 text-lg font-semibold px-3 py-2 rounded-lg transition ${
							isActive ? "bg-gray-800 text-gray-200" : "text-gray-800 hover:bg-gray-800 hover:text-gray-200"
						}`
					}
				>
